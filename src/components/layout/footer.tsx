    ...
    <footer className="border-t border-border/40 bg-background/95">
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 py-6 md:flex-row">
        ...
        <div className="flex items-center gap-2">
          <a href="https://linktr.ee/beetleheaddesigns?fbclid=PAZXh0bgNhZW0CMTEAc3J0YwZhcHBfaWQMMjU2MjgxMDQwNTU4AAGntRTMqpj4ouYNLg9wd-gDlFRJhJJ5nXxIBF3cRKPGm4-e0jyRhymXMk3Jv_o_aem_gP6fteq0jdyaI0nGL4E9Ew" target="_blank" rel="noopener noreferrer">
